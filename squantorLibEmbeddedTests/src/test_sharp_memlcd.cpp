...
MINUNIT_ADD(testBitBlockTransfer, testSharpMemLcdSetup, testSharpMemLcdTeardown) {
  ...
  testDevice.setBuffer(0x0000);
  testDevice.bitBlockTransfer(0, 0, testSetBlock, 8, 1, util::bitblitOperation::OP_MOV);
  minUnitCheck(testDevice.frameBuffer[0] == 0x0101);
  ...
  testDevice.bitBlockTransfer(1, 1, testClearBlock, 8, 2, util::bitblitOperation::OP_MOV);
  minUnitCheck(testDevice.frameBuffer[0] == 0x0101);
  ...
  testDevice.setBuffer(0x0000);
  testDevice.bitBlockTransfer(14, 1, testSetBlock, 4, 2, util::bitblitOperation::OP_MOV);
  minUnitCheck(testDevice.frameBuffer[0] == 0x0101);
  minUnitCheck(testDevice.frameBuffer[1] == 0x0000);
  minUnitCheck(testDevice.frameBuffer[2] == 0x0000);
  minUnitCheck(testDevice.frameBuffer[3] == 0x0201);
  ...
  // bounds check X
  testDevice.setBuffer(0x0000);
  testDevice.bitBlockTransfer(30, 1, testSetBlock, 4, 2, util::bitblitOperation::OP_MOV);
  minUnitCheck(testDevice.frameBuffer[0] == 0x0101);
  minUnitCheck(testDevice.frameBuffer[1] == 0x0000);
  minUnitCheck(testDevice.frameBuffer[2] == 0x0000);
  minUnitCheck(testDevice.frameBuffer[3] == 0x0201);
  ...
  // check inversion
  testDevice.setBuffer(0x0000);
  testDevice.bitBlockTransfer(14, 1, testClearBlock, 4, 2, util::bitblitOperation::OP_NOT);
  minUnitCheck(testDevice.frameBuffer[0] == 0x0101);
  minUnitCheck(testDevice.frameBuffer[1] == 0x0000);
  minUnitCheck(testDevice.frameBuffer[2] == 0x0000);
  minUnitCheck(testDevice.frameBuffer[3] == 0x0201);
